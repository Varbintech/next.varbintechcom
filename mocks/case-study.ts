...
const caseStudy1: CaseStudy = {
  ...
  projectDescription: [
    'The global retail platform for products from the past, present, and future. It provides over 2M listings from streetwear and designer brands with flexible filters and a top-notch user experience.',
  ],
  projectTags: [
    { name: 'Front-End', link: '#' },
  ...
  results: [
    '3+ years of cooperation with successfully implemented all needed features',
