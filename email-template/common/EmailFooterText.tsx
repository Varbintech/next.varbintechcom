...
export const EmailFooterText = () => {
  return (
    <Text style={footerSubParagraph}>
      Sent with
      <Img src="/images/heart.jpg" width="12" height="12" alt="heart emoji" style={footerImage} />
      from
      <Link href="#">
        <Img src="/images/logo-small.jpg" height="24" alt="Varbintech logo" style={footerLogo} />
      </Link>
      <br />
      <br />
